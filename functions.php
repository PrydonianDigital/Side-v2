...
function award_tax() {
	$labels = array(
		'name'                       => _x( 'Award Types', 'Taxonomy General Name', 'side' ),
		'singular_name'              => _x( 'Award Type', 'Taxonomy Singular Name', 'side' ),
		'menu_name'                  => __( 'Award Type', 'side' ),
		'all_items'                  => __( 'All Award Types', 'side' ),
		'parent_item'                => __( 'Parent Award Type', 'side' ),
		'parent_item_colon'          => __( 'Parent Award Type:', 'side' ),
		'new_item_name'              => __( 'New Award Type', 'side' ),
		'add_new_item'               => __( 'Add New Award Type', 'side' ),
		'edit_item'                  => __( 'Edit Award Type', 'side' ),
		'update_item'                => __( 'Update Award Type', 'side' ),
		'separate_items_with_commas' => __( 'Separate Award Types with commas', 'side' ),
		'search_items'               => __( 'Search Award Types', 'side' ),
		'add_or_remove_items'        => __( 'Add or remove Award Types', 'side' ),
		'choose_from_most_used'      => __( 'Choose from the most used Award Types', 'side' ),
		'not_found'                  => __( 'Not Found', 'side' ),
	);
	$args = array(
		'labels'                     => $labels,
		'hierarchical'               => true,
	...
	register_taxonomy( 'award_type', array( 'awards' ), $args );
}
// Hook into the 'init' action
add_action( 'init', 'award_tax', 0 );
function Founders() {
	$labels = array(
